...
class _ProfilePState extends State<ProfileP> {
   ...
   void _getInfo() async {
     ...
     textEditingController.text = 'edit qilindi';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
             ...
             ProfileCard(textEditingController),
...
Widget ProfileCard(TextEditingController textEditingController) {
  return  Container(
