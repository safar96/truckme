...
import 'package:truckme/page/main/main_add_p.dart';
                          ...
                          child: SizedBox(
                            ...
                            child: Stack(
                              ...
                              children: [
                                Container(
                                  height: _showId == ans[index].id
                                      ? getConfigHeight(0.68)
                                      : getConfigHeight(0.18),
                                  width: getConfigWidth(0.9),
                                  alignment: Alignment.topCenter,
                                  decoration: const BoxDecoration(
                                    color: Colors.white,
                                ...
                                Column(
                                  children: [
                                    SizedBox(
                                      height: _showId == ans[index].id
                                          ? getConfigHeight(0.65)
                                          : getConfigHeight(0.15),
                                    ),
                                    IconButtonCustom(
                                      height: getConfigHeight(0.05),
                                      width: getConfigWidth(0.2),
